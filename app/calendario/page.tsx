...
export default function CalendarioEscolar() {
  ...
  const [savedSemesters, setSavedSemesters] = useState(null)
  ...
  const countHolidaysInPeriod = (startDate, endDate) => {
  ...
  const calculateSemesterDays = (startDate, endDate) => {
  ...
  const countEventsByType = (eventType) => {
    let count = 0
    Object.entries(schoolEvents).forEach(([dateString, eventList]) => {
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <section className="lg:w-[70%] space-y-6">
            <Card className="border-red-200 bg-white mb-6">
              <CardHeader>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="grid gap-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="title" className="text-red-700">
                Título do Evento
              </Label>
              <Input
                id="title"
                ...
                className="col-span-3 border-red-200 focus:border-red-500"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="type" className="text-red-700">
                Tipo de Evento
              </Label>
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="py-4">
            <p className="text-gray-700">
              ...
              <span className="font-semibold block mt-1 text-red-800">
                {eventToDelete?.title} ({eventToDelete && getEventTypeLabel(eventToDelete.type)})
              </span>
            </p>
            {eventToDelete?.isRecurring && (
              <p className="text-sm text-yellow-600 mt-2 bg-yellow-50 p-2 rounded border border-yellow-200">
                <strong>Nota:</strong> Este é um evento recorrente. Ao excluir, você removerá apenas esta ocorrência
                específica.
              </p>
            )}
          </div>
          ...
          <div className="grid gap-6 py-4">
            ...
            <div className="space-y-4 border-b border-gray-200 pb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="academic-start" className="text-red-700">
                ...
                <div className="space-y-2">
                  <Label htmlFor="academic-end" className="text-red-700">
                    Fim do Ano Letivo
                  </Label>
                  <Input
                    id="academic-end"
              ...
              <Button onClick={saveAcademicYear} className="w-full bg-red-600 hover:bg-red-700 text-white">
                Salvar Ano Letivo
              </Button>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                <h4 className="text-sm font-semibold text-blue-800 mb-3">1º Semestre</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="sem1-start" className="text-blue-700 text-xs">
                      Início
                    </Label>
                    <Input
                      id="sem1-start"
                      ...
                      className="border-blue-200 focus:border-blue-500 h-8 text-sm"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="sem1-end" className="text-blue-700 text-xs">
                      Fim
                    </Label>
                    <Input
                      id="sem1-end"
              ...
              <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
                <h4 className="text-sm font-semibold text-purple-800 mb-3">2º Semestre</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="sem2-start" className="text-purple-700 text-xs">
                      Início
                    </Label>
                    <Input
                      id="sem2-start"
                      ...
                      className="border-purple-200 focus:border-purple-500 h-8 text-sm"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="sem2-end" className="text-purple-700 text-xs">
                      Fim
                    </Label>
                    <Input
                      id="sem2-end"
